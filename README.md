...
We incorporate some newly launched LLMs for comparison ([Gemma 2b and Gemma 7b](https://storage.googleapis.com/deepmind-media/gemma/gemma-report.pdf) by Google).
