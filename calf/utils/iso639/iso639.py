...
_DB = sqlite3.connect(
    os.path.join(os.path.dirname(os.path.realpath(__file__)), "iso639.db"),
)
...
class ISO639:
    ...
    @classmethod
    def match(cls, user_input) -> "ISO639":
...
@functools.lru_cache()
def _get_all_languages() -> List[ISO639]:
    return [
        _get_language(part3)
